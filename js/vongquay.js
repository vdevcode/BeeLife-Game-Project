...
let stoperPosition = 0; // Vị trí của stoper
...
btnSpin.addEventListener("click", () => {
    ...
    setTimeout(() => {
        ...
        let prize = document.querySelector(".container-vongquay div:nth-child(" + stoperPosition + ")");
        let prizeText = "";
        if (stoperPosition === 1) {
            prizeText = "Bee x2";
        }
        ...
        messageVongQuay.innerHTML = "Bạn nhận được: " + prizeText + "" + ", Chúc mừng nhé!!!"
        btnSpin.disabled = false;
